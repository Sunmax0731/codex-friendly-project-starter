...
- TODO / Issues / legacy Tasks 全体を一括開始 prompt として Codex CLI へ渡す導線を追加した。
- public GitHub Issues を選択して既定では local TODO / Issue に取り込み、設定時だけ legacy Task も作成する導線を追加した。
...
- `Issues/0010-start-all-work-items.md`: TODO / Issues / legacy Tasks 一括開始。closed。
