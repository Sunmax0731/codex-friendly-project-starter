...
- GUI フォームに自然言語メモを入力し、title、priority、type、phase、QCDS、acceptance criteria の下書きへ変換して Issue / Task を作成できる。
...
- Work Item Composer が自然言語から Issue / Task の下書きを作り、作成後に Tree View と Dashboard が更新される。
