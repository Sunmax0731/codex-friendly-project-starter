...
- Markdown Preview: 標準 preview は汎用表示に強いが、この拡張では TODO / Issue / QCDS のリンク遷移と work item 文脈を優先する。
...
- TODO / Issue / QCDS を同じ work item 画面から辿れるようにし、legacy Task は既存リンク互換だけ残す。
