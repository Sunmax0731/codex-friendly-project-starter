...
const product = {
  ...
  implFiles: [
    ...
    'src/codex-cli.cjs',
    'src/codex-flow.cjs',
    'src/codex-flow-runner.cjs',
    'src/codex-flow-webview.cjs',
  ...
  testFiles: [
    ...
    'tests/codex-flow.test.cjs',
    'tests/codex-flow-runner.test.cjs',
    'tests/codex-flow-webview.test.cjs',
...
function commandContract() {
  ...
  const required = [
    ...
    'codex-friendly-project-starter.repairFailedCodexFlowPhase',
    'codex-friendly-project-starter.openLatestCodexFlowHandoff',
