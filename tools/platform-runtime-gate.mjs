...
function runVsCodeExtensionGate() {
  ...
  const checks = [
    ...
    check('work-composer-command', commands.has('codex-friendly-project-starter.openWorkItemComposer') && commands.has('codex-friendly-project-starter.createWorkItemFromNaturalLanguage') && commands.has('codex-friendly-project-starter.initializeTasksDirectory'), 'Work Item Composer and legacy Tasks init commands exist'),
