...
const requiredCommands = [
  ...
  'codex-friendly-project-starter.stopCurrentCodexFlowPhase',
  'codex-friendly-project-starter.openLatestCodexFlowPhaseLog',
  'codex-friendly-project-starter.openCodexFlowFile',
  'codex-friendly-project-starter.copyCodexFlowGitDiffSummary',
