...
const requiredCommands = [
  ...
  'codex-friendly-project-starter.createBlockedFollowUpIssue',
...
const checks = [
  ...
  check('readme', includes('README.md', ['Codex Friendly Project Starter', 'Markdown WebView', 'Scaffold D:\\AI Default Docs', 'Start Selected Work Items', 'GitHub Issues 取込', 'Create Blocked Follow-up Issue', 'codex-sessions.md', 'VS Code Codex Handoff', 'OpenAI Prompt Guidance Sync', 'Model-Optimized Prompts', 'rg.exe', 'gh.exe']), 'README documents release-facing features'),
  check('manual-test', includes('docs/manual-test.md', ['Markdown WebView', 'Scaffold D:\\AI Default Docs', 'Start Selected Work Items', 'GitHub Issues 取込', 'Create Blocked Follow-up Issue', 'OpenAI 公式プロンプトガイド適用', 'Copy & Open Codex', 'rg.exe', 'gh.exe', 'Legacy Task を作成']), 'manual test covers visible commands and hidden legacy tasks'),
