...
const checks = [
  ...
  check('readme', includes('README.md', ['Codex Friendly Project Starter', 'Markdown WebView', 'Scaffold D:\\AI Default Docs', 'Start Selected Work Items', 'GitHub Issues 取込', 'rg.exe', 'gh.exe']), 'README documents release-facing features'),
  check('manual-test', includes('docs/manual-test.md', ['Markdown WebView', 'Scaffold D:\\AI Default Docs', 'Create Local Task', 'Start Selected Work Items', 'GitHub Issues 取込', 'rg.exe', 'gh.exe']), 'manual test covers new commands'),
  check('user-guide', includes('docs/user-guide.md', ['Markdown WebView', 'Tasks/*.md', 'D:\\AI', 'FirstPrompt 履歴', 'Start Selected Work Items', 'GitHub Issues 取込', 'インテリジェンス']), 'user guide covers docs scaffold, tasks, history, and Codex run options'),
