...
- Phase: 00_smoke / Codex Flow background runner smoke
...
- Current phase id: 00_smoke
- Current phase status: succeeded
...
- Branch: codex/codex-flow-qa-smoke
- HEAD: 3025c70
...
M dist/codex-friendly-project-starter-docs.zip
 ...
 M docs/manual-test.md
 M docs/vscode-verification-guide.md
 M src/codex-cli.cjs
 M src/codex-flow-runner.cjs
 M src/codex-flow.cjs
 M tests/codex-cli.test.cjs
 M tests/codex-flow-runner.test.cjs
 M tests/codex-flow.test.cjs
?? .codexflow/
?? docs/handoff/
?? prompts/
?? tmp/
...
- 実施日時: 2026-07-05 11:04-11:08 JST
...
- 不具合修正: smoke で、fallback handoff 生成時に `docs/handoff/latest.md` が
