...
$promptFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\50_release_check\20260705T075657Z.prompt.md'
$jsonlFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\50_release_check\20260705T075657Z.jsonl'
...
$codexArgs = @(
  ...
  'workspace-write'
  '-o'
  'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\50_release_check\20260705T075657Z.final.md'
  '--color'
  'never'
  '--json'
)
...
Write-Host 'promptFilePath: d:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\50_release_check\20260705T075657Z.prompt.md'
