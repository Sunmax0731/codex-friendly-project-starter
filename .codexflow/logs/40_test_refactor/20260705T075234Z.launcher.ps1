...
$promptFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\40_test_refactor\20260705T075234Z.prompt.md'
$jsonlFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\40_test_refactor\20260705T075234Z.jsonl'
...
$codexArgs = @(
  ...
  'workspace-write'
  '-o'
  'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\40_test_refactor\20260705T075234Z.final.md'
  '--color'
  'never'
  '--json'
)
...
Write-Host 'promptFilePath: d:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\40_test_refactor\20260705T075234Z.prompt.md'
