...
$promptFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\20_design\20260705T074307Z.prompt.md'
$jsonlFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\20_design\20260705T074307Z.jsonl'
...
$codexArgs = @(
  ...
  'workspace-write'
  '-o'
  'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\20_design\20260705T074307Z.final.md'
  '--color'
  'never'
  '--json'
)
...
Write-Host 'promptFilePath: d:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\20_design\20260705T074307Z.prompt.md'
