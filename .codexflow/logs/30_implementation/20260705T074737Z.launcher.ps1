...
$promptFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\30_implementation\20260705T074737Z.prompt.md'
$jsonlFile = 'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\30_implementation\20260705T074737Z.jsonl'
...
$codexArgs = @(
  ...
  'workspace-write'
  '-o'
  'd:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\30_implementation\20260705T074737Z.final.md'
  '--color'
  'never'
  '--json'
)
...
Write-Host 'promptFilePath: d:\AI\VSCodeExtension\codex-friendly-project-starter\.codexflow\logs\30_implementation\20260705T074737Z.prompt.md'
