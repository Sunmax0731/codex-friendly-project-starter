...
- VS Code Codex handoff / Codex CLI 起動時は対象プロジェクトの `docs/codex-sessions.md` と `docs/codex-sessions.jsonl` に session index を残し、Issue / legacy Task から起動した場合は対象 Markdown にも参照を追記します。
